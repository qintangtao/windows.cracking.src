...
int    __cdecl A_memcmp (const void * buf1, const void * buf2, size_t num); // Compares two blocks of memory
...
static inline void __cdecl cpuid_abcd (int abcd[4], int eax) {
   cpuid_ex(abcd, eax, 0);}
...
static inline int __cdecl Round (double x) {   // Overload name Round
   return RoundD(x);}
static inline int __cdecl Round (float  x) {   // Overload name Round
   return RoundF(x);}
static inline const char * __cdecl A_strstr(const char * haystack, const char * needle) {
...
public:
    ...
    __cdecl div_i32(int d) {                                           // Constructor with divisor
        setdivisor(d);
    }
    void __cdecl setdivisor(int d) {                                   // Set divisor
...
public:
    ...
    __cdecl div_u32(uint32_t d) {                                      // Constructor with divisor
        setdivisor(d);
    }
    void __cdecl setdivisor(uint32_t d) {                              // Set divisor
